...
static inline bool tag_is_id3v1(const unsigned char* data, size_t length)
{
	if (length >= 3 &&
...
static inline bool tag_is_id3v2(const unsigned char* data, size_t length)
{
	if (length >= 10 &&
 ...
 */
static inline bool tag_is_apetag(const unsigned char* data, size_t length)
{
	unsigned int v;
